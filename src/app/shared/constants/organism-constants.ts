...
export const DESCRIPTION_NAME_FORM_DEFAULT_MODEL: DescriptionNameFormModel =
    'category';
export const DESCRIPTION_NAME_FORM_DISABLED_BUTTON_STATE: ButtonState = 'disabled';
export const DESCRIPTION_NAME_FORM_ACTIVE_BUTTON_STATE: ButtonState = 'active';